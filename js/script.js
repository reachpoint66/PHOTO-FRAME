document.getElementById('imageInput').addEventListener('change', function (event) {
    ...
    // Tentukan lebar dan tinggi canvas mengikut lebar skrin
    canvas.width = window.innerWidth < 1080 ? window.innerWidth : 1080; // Setelkan lebar berdasarkan saiz skrin
    canvas.height = canvas.width; // Pastikan ketinggian canvas sama dengan lebar untuk nisbah 1:1
